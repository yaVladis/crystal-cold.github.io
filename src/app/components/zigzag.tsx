...
export default function Zigzag() {
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6" id="section-why-us">
        <div className="py-12 md:py-20 border-t border-gray-100">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="section-features__head">
              <h1 className="h2 mb-4 text-black">Why us</h1>
              <FaRegQuestionCircle />
            </div>
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">
              Your trusted partner for unmatched HVAC excellence
            </div>
          </div>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Highly trained and certified technicians</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                      ...
                      <span>
                        Extensive knowledge of HVAC systems and technologies
                      </span>
                    </li>
                    <li className="flex items-center">
                      ...
                      <span>
                        Proven track record of successful installations and
                        repairs
                      </span>
                    </li>
                  </ul>
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Prompt and reliable service</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    ...
                    <li className="flex items-center mb-2">
                      ...
                      <span>Wide range of HVAC products and brands</span>
                    </li>
                    <li className="flex items-center">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
