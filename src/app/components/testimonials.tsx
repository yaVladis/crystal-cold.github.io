      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6" id="section-reviews">
        <div className="py-12 md:py-20 border-t border-gray-100">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20" >
            ...
            <h1 className="h2 mb-4 text-black">Good service, happy client!</h1>
              <BsFillPersonCheckFill />
            </div>
            <p className="h4 mb-2 text-blue-400 text-center font-architects-daughter">
              At our H<span className="text-yellow-400">V</span><span className="text-red-400">AC</span> company, customer satisfaction is our utmost priority.
              We strive to exceed your expectations by delivering exceptional
              service and personalized attention to each client.
            </p>
          </div>
